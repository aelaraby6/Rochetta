    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300 mb-1">
          ...
          <label className="font-semibold">Strips per Box {isAddMode && "(Optional)"}</label>
        </div>
        <input
          type="number"
      ...
      <div className="flex flex-col gap-1 md:col-span-2">
        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300 mb-1">
          ...
          <label className="font-semibold">{isAddMode ? "Product Image" : "Update Product Image"}</label>
        </div>
        <input
          type="file"
          accept="image/*"
      ...
      <div className="flex items-center gap-3 md:col-span-2 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
        ...
        <div className="flex items-center gap-2 flex-grow">
          ...
          >
            Requires Medical Prescription {isAddMode && "(Roshetta)"}
          </label>
        </div>
      </div>
